...
const wordData = {
  ...
  isIrregular: props.word.isIrregular || false
}

const selectCategory = ref(wordData.category)
console.log(wordData.category)
const selectVerbType = ref(wordData.isIrregular.value ? 'irregular' : 'regular')
